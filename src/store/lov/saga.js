...
function* fetchGetWilayah2({ payload: req }) {
  try {
    const response = yield call(getLovWilayah2, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetPetak2({ payload: req }) {
  try {
    const response = yield call(getLovPetak2, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetKegiatan({ payload: req }) {
  try {
    const response = yield call(getLovkegiatan, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetQCBap({ payload: req }) {
  try {
    const response = yield call(getLovQcBap, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetClone({ payload: req }) {
  try {
    const response = yield call(getLovClone, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetClone2({ payload: req }) {
  try {
    const response = yield call(getLovClone2, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetStore({ payload: req }) {
  try {
    const response = yield call(getLovStore, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetProduct({ payload: req }) {
  try {
    const response = yield call(getLovProduct, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetJarakTanam({ payload: req }) {
  try {
    const response = yield call(getLovJarakTanam, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* fetchGetRumusTegakan({ payload: req }) {
  try {
    const response = yield call(getLovRumusTegakan, req)
    if(response.status == 1){
      yield put(msgLov(response))
    }else{
      yield put(msgLov(response))
...
function* lovSaga() {
  ...
  yield takeEvery(LOV_PETAK2, fetchGetPetak2)
  ...
  yield takeEvery(LOV_KEGIATAN, fetchGetKegiatan)
  yield takeEvery(LOV_QCBAP, fetchGetQCBap)
  yield takeEvery(LOV_CLONE, fetchGetClone)
  yield takeEvery(LOV_CLONE2, fetchGetClone2)
  yield takeEvery(LOV_STORE, fetchGetStore)
  yield takeEvery(LOV_PRODUCT, fetchGetProduct)
  yield takeEvery(LOV_JARAK_TANAM, fetchGetJarakTanam)
  yield takeEvery(LOV_RUMUS_TEGAKAN, fetchGetRumusTegakan)
  yield takeEvery(LOV_WILAYAH2, fetchGetWilayah2)
