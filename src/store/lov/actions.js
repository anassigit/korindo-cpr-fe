...
export const getKegiatan = (resp) => ({
  type: LOV_KEGIATAN,
  payload: resp,
})

export const getQcBap = (resp) => ({
  type: LOV_QCBAP,
  payload: resp,
})

export const getClone = (resp) => ({
  type: LOV_CLONE,
  payload: resp,
})

export const getClone2 = (resp) => ({
  type: LOV_CLONE2,
  payload: resp,
})
...
export const getJarakTanam = req => ({
  type: LOV_JARAK_TANAM,
  payload: req,
})

export const getRumusTegakan = req => ({
  type: LOV_RUMUS_TEGAKAN,
  payload: req,
})
